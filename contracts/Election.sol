...
contract Election {
    ...
    /*lo si mette nel costruttore per dare una proprietà allo smart contract, 
    in modo da poter compiere alcune azione precise, come ad esempio 
    resettare la votazione o remunerare i vincitori
    */
    address private owner;
    
    //numero di voti per poter conscludere la votazione
    uint256 public maxVotes;
    
    //numero totali di votazioni effettuate
    uint256 public totalVotes;
    
    /* mapping field below is equivalent to an associative array or hash.
    The key of the mapping is candidate name stored as type address and value is
    an unsigned integer to store the vote count
    */
    mapping (address => uint256) public votesReceived;
    
    //lista dei candidati alla votazioni
    address[] public candidateList;
    
    //lista dei vincitori, chi ha ricevuto più voti
    ...
    */
    ...
    //una mappa non puo essere eliminata, ma solo "pulita" iterando
